...
public class Catalina {
    ...
    public void load() {
        ...
        try {
            ...
            try {
                ...
                // 将server.xml解析本对象域中,以server变量接受
                digester.push(this);
    ...
    protected void initDirs() {
        ...
        // 初始化 catalinaHome 目录为系统jvm参数
        String catalinaHome = System.getProperty(Globals.CATALINA_HOME_PROP);
        if (catalinaHome == null) { // 若参数为空，则是用默认目录
            // Backwards compatibility patch for J2EE RI 1.3
            String j2eeHome = System.getProperty("com.sun.enterprise.home");
            if (j2eeHome != null) {
                // 若不为 null,则将其设置为 catalinaHome
                catalinaHome = System.getProperty("com.sun.enterprise.home");
            } else if (System.getProperty(Globals.CATALINA_BASE_PROP) != null) {
                // 若为null,且CATALINA_BASE_PROP不为null则将CATALINA_BASE_PROP设置为catalinaHome
        ...
        if (catalinaHome != null) {
            // 根据 catalinaHome创建文件目录
            File home = new File(catalinaHome);
            if (!home.isAbsolute()) {   // 查看路径是否为绝对路径
                try {
                    // 将home路径的规范路径名字符串赋值给catalinaHome
        ...
        // 如果CATALINA_BASE_PROP为空,则将catalinaHome设置为CATALINA_BASE_PROP
